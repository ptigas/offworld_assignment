...
register(
    id='GazeboFlatTurtlebotLidar-v0',
    entry_point='gym_gazebo.envs:GazeboFlatTurtlebotLidarEnv',
    # More arguments here
)
register(
...
register(
    id='GazeboFlatTurtlebotLidarNn-v0',
    entry_point='gym_gazebo.envs:GazeboFlatTurtlebotLidarNnEnv',
    # More arguments here
)
register(
